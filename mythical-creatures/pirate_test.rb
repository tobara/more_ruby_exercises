...
### Write your own tests ###
  def test_a_pirate_can_rob_ships
    # skip
     pirate = Pirate.new("Jack")
     refute pirate.did_some_robbon?

     pirate.rob_ship
     assert pirate.did_some_robbon?
  end

  def test_a_pirate_stars_with_zero_booty
    # skip
    pirate = Pirate.new("Jack")
    assert_equal 0, pirate.how_much_booty?
  ...
  def test_a_pirate_gets_100_booty_for_robbon
    ...
    pirate = Pirate.new("Jack")
    pirate.rob_ship
    assert_equal 100, pirate.how_much_booty?
  end
end
