...
class FindTest < Minitest::Test
  ...
  def test_no_waldo
    ...
    found = words.find { |w| w == "waldo" ? w : nil }
  ...
  def test_cannot_find_3_letter_words
    ...
    found = words.find { |w| w.length == 3 ? w : nil}
    assert_nil nil, found
  end
  ...
  def test_find_13
    ...
    found = numbers.find { |n| n.eql?(13) ? n : nil }
  ...
  def test_find_first_multiple_of_3
    ...
    found = numbers.find { |n| n % 3 == 0 ? :& : nil }
  ...
  def test_find_first_word_starting_with_q
    ...
    found = words.find{ |w| w[0].include?('q') ? :& : nil }
