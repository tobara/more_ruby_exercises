...
class FindPatternTest < Minitest::Test
  ...
  def test_find_13
    ...
    found = nil
    numbers.each { |n| n == 13 ? found = n : nil }
  ...
  def test_find_first_word_starting_with_q
    ...
    found = nil
    words.each { |w| w.start_with?('q') ? (found = w; break ) : nil }
  ...
  def test_find_first_word_ending_with_er
    ...
    found = nil
    words.each { |w| w.end_with?('er') ? (break found = w) : nil }
  ...
  def test_find_first_number_greater_than_20
    ...
    found = nil
    numbers.each { |n| found = n; break if n > 20 }
